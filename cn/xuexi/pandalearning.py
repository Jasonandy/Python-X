...
import random
from cn.xuexi.pdlearn import version
from cn.xuexi.pdlearn import user
from cn.xuexi.pdlearn import dingding
from cn.xuexi.pdlearn import mydriver
from cn.xuexi.pdlearn import score
from cn.xuexi.pdlearn import threads
from cn.xuexi.pdlearn import get_links
...
if __name__ == '__main__':
    ...
    # 起一条线程获取更新信息 - 多线程 导致前端显示的时候 前后有数据出入
